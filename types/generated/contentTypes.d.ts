...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    socialLinks: Schema.Attribute.Component<'shared.social-media-link', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPartnerBannerPartnerBanner extends Struct.SingleTypeSchema {
  collectionName: 'partner_banners';
  info: {
    displayName: 'Partner Banner';
    pluralName: 'partner-banners';
    singularName: 'partner-banner';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiRequestFormRequestForm extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    YouFormLink: Schema.Attribute.String;
  };
}
